        ...
        vim.api.nvim_create_autocmd("LspAttach", {
            ...
            callback = function(ev)
                ...
                keymap.set("n", "<leader>lt", "<cmd>Telescope lsp_type_definitions<CR>",
                    { desc = "LSP type definitions" })                                                         -- show lsp type definitions
                ...
                keymap.set("n", "<leader>lD", "<cmd>Telescope diagnostics bufnr=0<CR>",
                    { desc = "Show buffer diagnosis" })                                                           -- show  diagnostics for file
